...
class HourglassModel():
	...
	"""
	def __init__(self, joints, nFeat=512, nStack=4, nModules=1, nLow=4, outputDim=16, batch_size=16, drop_rate = 0.2, lear_rate = 2.5e-4, decay = 0.96, decay_step = 2000, dataset = None, training = True, w_summary = True, logdir_train = None, logdir_test = None,tiny = True, attention = False,modif = True,w_loss = False, name = 'tiny_hourglass'):
		""" Initializer
		Args:
	...
	def training_init(self, nEpochs = 10, epochSize = 1000, saveStep = 500, saver_dir = 'saver', dataset = None, load = None):
